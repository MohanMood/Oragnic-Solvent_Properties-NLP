...
dataset = load_dataset('csv', data_files={
    'train': 'Enthalpy-Vap_train_dataset.csv',
    'validation': 'Enthalpy-Vap_val_dataset.csv',
    'test': 'Enthalpy-Vap_test_dataset.csv'
}, delimiter=',')
...
small_train_dataset.to_csv('Enthalpy-Vap_train_ChemBERTa_dataset.csv', index=False)
small_eval_dataset.to_csv('Enthalpy-Vap_val_ChemBERTa_dataset.csv', index=False)
...
# Training arguments
para_output_dir = '/Machine-Learning/LLM/'
...
pd_train.to_csv(f'Organic_Solvents_Enthalpy-Vap_Train_Predictions-{seed}seed.csv', index=False)
...
pd_test.to_csv(f'Organic_Solvents_Enthalpy-Vap_Test_Predictions-{seed}seed.csv', index=False)

...
# Train CatBoost
cat_model = CatBoostRegressor(verbose=250)
...
train_df.to_csv(f'CATBoost_MorganFP-Training_LogP-{seed}seed.csv', index=False)
...
test_df.to_csv(f'CATBoost_MorganFP-Testing_LogP-{seed}seed.csv', index=False)
